...
namespace TasksApi.Controllers
{
    ...
    public class UsersController : BaseApiController
    {
        ...
        public async Task<IActionResult> Signup(SignupRequest signupRequest)
        {
            ...
            {
                IEnumerable<string> errors = ModelState.Values.SelectMany(x => x.Errors.Select(c => c.ErrorMessage)).ToList();
        ...
        {
            LogoutResponse logout = await userService.LogoutAsync(UserID);
